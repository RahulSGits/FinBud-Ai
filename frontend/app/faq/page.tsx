...
const FAQS = [
  { q: 'How does the AI handle accents and regional languages?', a: 'FinBud integrates with specialized voice providers like Sarvam AI for fluent Indian languages and ElevenLabs for global accents, ensuring high-quality, natural-sounding conversations. The underlying LLM is prompt-engineered to understand context and mixed-languages (like Hinglish).' },
  ...
  { q: 'Is there a limit to how many concurrent calls I can make?', a: 'Concurrency limits depend on your subscription plan. The Starter plan includes 2 concurrent calls, while the Business plan scales up to 20. If you need massive concurrency (e.g. 1,000+ simultaneous calls for outbound blasts), contact sales for an Enterprise plan.' },
